...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="images/icon.png" alt="AdminLTELogo" height="200" width="200">
  </div>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <!-- <div class="container"><a class="navbar-brand" href="#"> <img src="images/logo1.png" alt=""></a></div> -->
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <!-- action dropdown circular personal -->
        <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#">
            <img src="images/profile.png" class="img-circle" alt="User Image" width="30px" height="30px">
            </a>
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            <a href="#" class="dropdown-item">
                 Action
            ...
            <div class="dropdown-divider"></div>
            <a href="#" class="dropdown-item dropdown-footer">Something else here</a>
            </div>
        </li>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2023 <a href="#">sapisehat.com</a>.</strong>
    All rights reserved.
